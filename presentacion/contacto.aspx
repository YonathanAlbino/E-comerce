    ...
    <div class="row g-3">
        ...
        <div class="col-6">
            <div class="centrado">
                ...
                <div class="mb-3">
                    <asp:Button Text="Enviar" CssClass="btn btn-primary mb-3" ID="btnEnviar" runat="server" />
                </div>

                <div class="wave" style="height: 150px; overflow: hidden;">
                    <svg viewBox="0 0 500 150" preserveAspectRatio="none" style="height: 100%; width: 100%;">
                        <path d="M0.00,49.98 C149.99,150.00 349.20,-49.98 500.00,49.98 L500.00,150.00 L0.00,150.00 Z" style="stroke: none; fill: #08f;"></path></svg>
                </div>
